...
/// Screen form on-click callback for sign up and log in.
///
/// helperFunction: either sign up or log in helper function defined in this module.
/// Redirects to HomeScreen if helperFunction returns empty message.
/// Otherwise stays on current screen and displays a snack message.
...
/// The sign up helper function
///
/// Called by authFormSubmitHelper in this module.
/// Calls _addUserDB in this module to update realtime database with "some" user data.
...
/// Realtime database updater for sign up.
///
/// Currently adds email, firstName, and lastName.
...
/// The log in helper funcion
///
/// Called by any screen programmatically or manually by the drawer component's Log out button.
...
///
/// Called by any screen that needs userInfo.
/// Could by replaced by app-wide state.
